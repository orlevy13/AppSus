...
var gEmails = [
    { from: 'John', subject: 'Wassap?', body: 'Pick up! im not read yet', isRead: false, isSent: false, isStarred: false, sentAt: 1551133930594, id: utilService.makeId() },
    ...
    { from: 'Anonymus', subject: 'third email here! STARRED!! and sent!', body: 'Pick up!,im read!', isRead: true, isSent: true, isStarred: true, sentAt: 1551133930594, id: utilService.makeId() },
    ...
    { from: 'A.Einstein', subject: `Two things are infinite:`, body: `the universe and human stupidity. and I'm not sure about the universe.`, isRead: true, isSent: true, isStarred: true, sentAt: 1551133930594, id: utilService.makeId() },
    {
